...
<%
	...
	%>
	<script>
	window.alert("수강생 정보 등록중입니다.")
	location.href = '/semi2_AcademicManage/manager/teacher/mteacherList.jsp'
	</script>
	<%
	return;
	}
  ...
  <form name = "mstudentInfo" method = "post">
  		<div class = "info-box">
            ...
            <div class="image-placeholder">
                <img src=<%=dto.getImgaddr() %> alt="선생님이미지테스트">
            </div>
  			...
  			<td class = "cell-data"><%=dto.getSeleclass() %></td>
  			</tr>

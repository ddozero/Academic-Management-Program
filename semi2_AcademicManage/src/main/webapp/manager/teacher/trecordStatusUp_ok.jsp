...
String msg = result>0?"근태 상태가 변경되었습니다.":"다시 확인해주세요.";

%>

<script>
window.alert('<%=msg%>')
location.href='/semi2_AcademicManage/manager/teacher/mteacherAttendList.jsp?groupidx=<%=groupidx_s %>&attendate=<%=attendateUrl%>';
</script>
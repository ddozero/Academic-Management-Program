...
<%@include file="/header/managerHeader.jsp"%>
 ...
 <div class = "all-title1">
  ...
  <section class= "all-section-board">
  	<article>
  		<form name = "mBoardWrite" action = "mBoardWrite_ok.jsp" method="post">
  		...
  		<table class = "table-add">
  			<tr>
  				...
  				<td class="cell-data"><input type="password" name="pwd"></td>
  			...
  			<tr>
  				...
  				<td colspan = "5" class="cell-data"><input type="text" name = "title" size ="50"></td>
  			</tr>
  			
  			<tr>
  				<td colspan = "6" class="cell-data">
  				<textarea class="textarea-custom" rows = "8" cols ="45" name="content"  style = "height : 400px;"></textarea>
  			</tr>
  		</table> 		

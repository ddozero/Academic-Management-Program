     ...
     <div class="image-box">
      ...
      <table class="info-table">
        <tr>
          ...
          <td><input type= "text" name="sex" value="<%= dto.getSex() %>" readonly></td>
        </tr>
        <tr>
          <td class="label">생년월일</td>
          <td><input type="text" name="birth" value="<%= dto.getBirth() %>" readonly></td>
          <td class="label">연락처</td>
          <td><input type = "text" name = "tel" value = "<%=dto.getTel() %>" readonly></td>
        </tr>
        <tr>
       	  <td class="label">이메일</td>
       	  <td><input type="text" name="email" value="<%= dto.getEmail() %>" readonly></td>
          <td class="label">주소</td>
          <td><input type="text" name="addr" value="<%= dto.getAddr() %>" readonly></td>
        </tr>
        <tr>
        ...
        <tr>
          <td class="label">반</td>
          <td><input type="text" name="groupname" value="<%= dto.getGroupname()%>" readonly></td>
          <td class="label">담당강좌명</td>
          <td><input type="text" name="classidx" value="<%= dto.getClassname()%>" readonly></td>
        </tr>
        <tr>
